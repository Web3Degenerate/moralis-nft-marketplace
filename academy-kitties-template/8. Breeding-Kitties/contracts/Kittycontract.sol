...
// bytes4 internal constant = bytes4(keccak256("onERC721Received(address,address,uint256,bytes)")); 
 ...
 //Constants set in: https://academy.moralis.io/lessons/erc165-implementation   
    bytes4 private constant _INTERFACE_ID_ERC721 = 0x80ac58cd;
    bytes4 private constant _INTERFACE_ID_ERC165 = 0x01ffc9a7;

// Added constants for ERC721 and ERC165 in: https://academy.moralis.io/lessons/erc165-implementation
...
// DOUBLE safeTransferFrom (public and internal) solution: https://academy.moralis.io/lessons/safetransferfrom-assignment-solution
    function safeTransferFrom(address _from, address _to, uint256 _tokenId) public {
        safeTransferFrom(_from, _to, _tokenId, ""); //empty string as data
    }
...
//(00:57): https://academy.moralis.io/lessons/safetransferfrom-assignment-solution
        // _spender is from         OR _spender is approved for tokenId OR  _spender is operator for _from
