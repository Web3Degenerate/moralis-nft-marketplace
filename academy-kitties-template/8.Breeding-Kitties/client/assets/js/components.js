//components.js FROM: https://github.com/Ivan-on-Tech-Academy/academy-cryptokitties/blob/dev/client/assets/js/components.js
...
function menu(){
    ...
    var menu = `<nav class="menu navbar navbar-expand-md navbar-light fixed-top bg-ligh p-4">
      <div class="container">
          <a class="navbar-brand" href="index.html"><b>Web3 Crypto Kitties NFT Maker</b></a>
          ...
          <div class="navbar-collapse collapse  justify-content-end" id="navbarsExampleDefault">
              ...
              <div align="right">
                  <ul class="navbar-nav mr-auto">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="factory.html"><b>Cat Factory</b></a>
                      </li>
